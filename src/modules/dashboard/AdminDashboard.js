...
export const AdminDashboard = () => {
  return (
    <div className="content-wrapper" style={{ minHeight: 313 }}>
                ...
                <div className="tab-content p-0">
                  ...
                  >
                    ...
                    <canvas
                      ...
                      height={300}
                      style={{ height: 300, display: "block", width: 620 }}
                      width={620}
          ...
          <section className="col-lg-5 connectedSortable ui-sortable">
            ...
            <div className="card bg-gradient-primary">
              ...
              <div className="card-body">
                ...
                >
                  <svg width="427.078" height={250}>
                    <g transform="scale(0.42158516020236086) translate(27.014508000000006, 0)">
                      <path
